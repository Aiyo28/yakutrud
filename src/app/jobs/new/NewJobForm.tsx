  ...
  return (
    <main className="m-auto my-10 max-w-3xl space-y-10">
      ...
      <div className="space-y-6 rounded-lg border p-4 pb-20">
        <div>
          <h2 className="text-center font-semibold">Детали вакансии</h2>
        ...
        <Form {...form}>
          ...
          >
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="а.е. Фронтенд-разработчик" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Select
                      ...
                      onChange={(e) => {
                        field.onChange(e);
                        if (e.currentTarget.value === "Удаленно") {
                          trigger("location");
                        }
                      }}
                    >
            ...
            <LoadingButton
              type="submit"
              className="float-right ml-2 mt-10 rounded bg-blue-400 px-2 py-1 text-sm font-bold text-white hover:bg-blue-600"
